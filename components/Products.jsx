...
const PRODUCTS = [
  {
    icon: '🔒', name: 'Security Shutters', desc: 'Heavy-duty roller shutters engineered for maximum intruder resistance. Ideal for banks, warehouses, and high-value premises.',
  ...
  {
    icon: '🏪', name: 'Shop Front Shutters', desc: 'Clean, commercial-grade shutters that project a professional image while securing your retail space overnight.',
  ...
  {
    icon: '🚗', name: 'Garage Shutters', desc: 'Space-saving roller garage doors for residential and commercial properties. Smooth, quiet, and built for daily use.',
  ...
  {
    icon: '🏭', name: 'Industrial Shutters', desc: 'Oversized, high-cycle shutters for factories, warehouses, and loading docks. Built to handle heavy commercial traffic.',
    features: ['High-speed variants available', 'Wind-rated & weatherproof', '3-phase motor options', 'Regulatory-compliant safety edges'],
  },
  {
    icon: '⚡', name: 'Electric Gates', desc: 'Sliding, swing, and bi-fold automated gates for estates, offices, and residential compounds. Elegance meets access control.',
  ...
  {
    icon: '🪟', name: 'Window Shutters', desc: 'Roller and fixed-bar window security solutions for apartments, offices, and retail spaces — discreet and effective.',
    ...
    <section id="products" className="section section-steel">
      ...
      <div style={{
        ...
        {PRODUCTS.map((p) => (
          <div
            key={p.name}
            style={{ background: 'var(--panel)', padding: '2.5rem 2rem', cursor: 'pointer', position: 'relative', overflow: 'hidden' }}
            onMouseEnter={e => {
          ...
          >
            <div className="top-bar" style={{
              ...
              background: 'var(--gold)', transform: 'scaleX(0)', transformOrigin: 'left', transition: 'transform 0.3s',
            }} />
            <div style={{
              width: 48, height: 48, background: 'rgba(212,146,10,0.1)', border: '1px solid rgba(212,146,10,0.2)',
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--muted)', lineHeight: 1.6, marginBottom: '1.5rem' }}>{p.desc}</p>
