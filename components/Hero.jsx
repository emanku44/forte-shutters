    ...
    <section id="hero" style={{
      ...
      <div style={{ position: 'relative', maxWidth: 680, width: '100%' }}>
        <div style={{
          ...
          <span style={{ width: 6, height: 6, background: 'var(--gold-light)', borderRadius: '50%', animation: 'pulse 2s infinite', flexShrink: 0 }} />
        ...
        <div className="hero-stats" style={{
          ...
          {[['500+','Installations'],['10+','Years Experience'],['3','Major Cities'],['24/7','Emergency Support']].map(([val, label]) => (
            <div key={label}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.6rem, 5vw, 2.2rem)', fontWeight: 700, color: 'var(--gold-light)', lineHeight: 1 }}>{val}</div>
